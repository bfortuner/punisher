...
available_indicators = in_df['Indicator Name'].unique()
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Slider(
            ...
            min=in_df['Year'].min(),
            max=in_df['Year'].max(),
            value=in_df['Year'].max(),
            step=None,
            marks={str(year): str(year) for year in in_df['Year'].unique()}
        ),
            dcc.RadioItems(
...
def update_graph(xaxis_column_name, yaxis_column_name,
                 ...
                 year_value):
    dff = in_df[in_df['Year'] == year_value]
