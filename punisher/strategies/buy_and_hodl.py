...
class BuyAndHodlStrategy(Strategy):
    def __init__(self, asset, quantity, target_hodl_ratio=.08):
        ...
        self.target_hodl_ratio = target_hodl_ratio
        self.reserve_ratio = 1.0 - self.target_hodl_ratio
        self.is_buying = True
    ...
    def handle_data(self, data, ctx):
        portfolio = ctx.record.portfolio
        target_hodl_value = (self.target_hodl_ratio
            * portfolio.starting_cash)
        reserve_value =  (self.reserve_ratio
            * portfolio.starting_cash)
